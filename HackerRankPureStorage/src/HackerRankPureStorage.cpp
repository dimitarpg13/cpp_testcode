//============================================================================
// Name        : HackerRankPureStorage.cpp
...
// Problem Statement:
//
// Problem 0 from SelectedProblems 8-25_to_8-31
// Let V denotes an integer. Remove all subsequences with repeating value V
// reducing each subsequence to a single node with that value V. (Value Compaction problem)
...
void remove_repetitions(node ** list, int val)
{
    node * c = *list, * n = NULL;
    while (c != NULL)
    {
...
bool test_case1()
{
    ...
    int res[] = {1, 2, 5, 2, 3, 7, 8};
    return validate_list(&list, res, 7);
}
...
bool test_case3()
{
    ...
    remove_repetitions(&list, 1);

    int res[] = {1, 2, 5, 2, 2, 2, 3, 7, 8};
