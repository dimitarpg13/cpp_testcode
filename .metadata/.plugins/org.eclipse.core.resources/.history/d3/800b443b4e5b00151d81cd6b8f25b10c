...
private:
	...
	char m_cLastRemoved;
    unsigned short m_iFailedAssignments;
...
public:
	...
	Symbol(char val, HorizLine * row, VertLine * col, Region * region = NULL) :
		...
		m_pAssignments(NULL), m_cLastRemoved(0), m_iFailedAssignments(0)
    { }
	...
	unsigned short getFailedCount() { return m_iFailedAssignments; }
    ...
    void incrementFailedCount() { m_iFailedAssignments++; }
