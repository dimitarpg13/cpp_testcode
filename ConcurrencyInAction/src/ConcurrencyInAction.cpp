...
{
	std::cout << "Calling do_low_level_stuff()" << std::endl;
	return 42;
};
...
{
	std::cout << "Calling from high_level_stuff(int some_param) with some_param = " << some_param << std::endl;
};
...
void do_other_stuff()
{
  std::cout << "Calling from do_other_stuff()" << std::endl;
};
